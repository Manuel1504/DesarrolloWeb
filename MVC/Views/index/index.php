<div class="container text-center">
  <div class="col-md-12">
    <h3>Bienvenido <strong> <?php echo $_SESSION["username"];  ?></strong> <br> Framewok hecho por <i>Manuel Flores</i></h3>
  </div>

  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="NJSPUMEM62XSC">
