...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $_layoutParams["route_css"]?>/normalize.css">
        ...
        <script src="<?php echo $_layoutParams["route_js"]?>/vendor/jquery-1.11.2.min.js"></script>
        <script src="<?php echo $_layoutParams["route_js"]?>/vendor/modernizr-2.8.3.min.js"></script>
        <script src="<?php echo $_layoutParams["route_js"]?>/main.js"></script>
        <script src="<?php echo $_layoutParams["route_js"]?>/plugins.js"></script>
